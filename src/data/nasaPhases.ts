...
export const NASA_PHASES: NASAPhase[] = [
  {
    ...
    payloadTons: 4,
    crewCount: 4,
    description: 'Commercial robotic precursors + first Artemis crewed landings. Bipartisan budget: ~$20B over 7 years. Moon Base missions I–III launching 2026 to reduce risk ahead of crewed landings.',
    highlights: [
      'Moon Base I: Blue Moon MK1 → Shackleton Connecting Ridge (fall 2026)',
      'Moon Base II: Griffin lander + Astrolab FLIP rover (2026)',
      'Moon Base III: Nova-C Trinity + Lunar Vertex (ESA/KASI, 2026)',
      'LTV awards: Astrolab CLV-1 ($219M) + Lunar Outpost Pegasus ($220M)',
      'MoonFall: 4 JPL drones via Firefly Aerospace spacecraft (2028)',
    ...
    keyMissions: [
      'Moon Base I: Blue Moon MK1 → Shackleton Ridge (fall 2026)',
      'Moon Base II: Astrobotic Griffin + Astrolab FLIP rover (2026)',
      'Moon Base III: IM Nova-C Trinity + Lunar Vertex/PRISM (2026)',
      'Artemis II: Crewed lunar flyby (2026)',
      'Artemis IV: First crewed Moon landing (2028)',
      'Artemis V: Second crewed landing (late 2028)',
      'CLPS 2.0 RFP: Responses due June 30, 2026',
